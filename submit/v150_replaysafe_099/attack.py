...
REPLAY_SAFE_FRAC = 0.99       # v150 08-18 push further: v148 (0.975->0.985)
# scored 88.245, beating v140/v142=87.705 by +0.540 and confirming that the
# 2026-08-05 partial-score-preserving replay change (discussion 733058)
# softens the downside of a higher safety fraction. This is the next rung on
# that same knob (0.985 -> 0.99) to see whether the gain continues or the
# frac boundary itself becomes the limiting factor. If v150 > v148, keep
# pushing; if v150 < v148, treat 0.985 as the local optimum for this frame.
