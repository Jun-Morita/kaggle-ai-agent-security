# ruff: noqa: E402
"""
Close transfer of public notebook `JED Attack : Adaptive 1.2x Margin`.

Active verifier: interact with the target, inspect public predicates from the
trace, and return only candidates that triggered at least one predicate during
attack generation.
"""
...
class AttackAlgorithm(AttackAlgorithmBase):
    """Adaptive verified SECRET_MARKER collector."""
