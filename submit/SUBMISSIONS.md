...
|---|---|---|---:|---:|---|---|---|
| v003_broad_prompt_bank | 2026-06-13 | `workspace/exp002_broad_prompt_bank` |  |  | `junichiromorita/ai-agent-security-v003-broad-prompt-bank` v1 | `baseline-solution-4-900`, `submit/v002_public_reachable` | Submitted as ref `53625867`; status still pending after repeated CLI checks. Mixes `v002` exfil core with broad destructive, confused-deputy, and untrusted prompt-bank probes. Local validate passed; deterministic smoke 60s completed with attack score 0.00. |
