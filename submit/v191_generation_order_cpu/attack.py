...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def _fill(
        ...
        # The refreshed evaluator preserves partial replay credit.  Preserve
        # live discovery order so the early returned prefix matches the first
        # candidates actually validated, rather than reordering by latency.
