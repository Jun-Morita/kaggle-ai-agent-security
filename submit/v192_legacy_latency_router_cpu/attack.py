...
SPLIT_CLASSIFY_N = 6           # v192: old latency-threshold router probe count
        ...
        while len(timed_cands) < cap:
            ...
            if burst_k == 1:
                ...
                if slow_row and slow_multipost_n > 1:
                    ...
                    # Restore only the old classifier mechanism: six ordinary
                    # probes, then route the remaining fill by mean latency.
