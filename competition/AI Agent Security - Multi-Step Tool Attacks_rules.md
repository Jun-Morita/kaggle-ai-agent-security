...
source: "https://www.kaggle.com/competitions/ai-agent-security-multi-step-tool-attacks/rules"
author:
published:
created: 2026-06-13
...
**[See Section 3.18 for defined terms](https://www.kaggle.com/competitions/ai-agent-security-multi-step-tool-attacks/rules#18.-terms)**
...
In addition to the main leaderboard prizes, we are offering two optional **Working Note Awards** of **$2,500 each** for the best written descriptions of participants’ methods, findings, and lessons learned. Please refer to the section about the [Working Note Award](https://www.kaggle.com/competitions/ai-agent-security-multi-step-tool-attacks/overview/working-note-awards-optional) for more details, and refer to the [Evaluation section](https://www.kaggle.com/competitions/ai-agent-security-multi-step-tool-attacks/overview/evaluation) to find the evaluation criteria for this award.
...
The test environment is published under MIT 2.0
...
1. **Open Source:** You hereby license and will license your winning Submission and the source code used to generate the Submission under [MIT](https://opensource.org/license/mit), an Open Source Initiative-approved license (see [www.opensource.org](http://www.opensource.org/)) that in no event limits commercial use of such code or model containing or depending on such code.
