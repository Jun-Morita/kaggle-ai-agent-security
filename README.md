...
The 2026-08-05 evaluator / leaderboard refresh is a new scoring regime. Old and new public scores are not directly comparable. Historical best `v123_v121_exact_rerun=91.890` remains the best pre-refresh evidence, but the current confirmed post-refresh best is `v148_replaysafe_postrefresh_push=88.245` (2026-08-17), unbeaten by five further single-knob throughput pushes (`v150`-`v155`, `v151`) on 2026-08-18/19.

A refreshed public leaderboard snapshot on 2026-08-19 had `1885` valid-scored teams (downloaded in full, not just the visible top rows). The top-5% public Silver boundary was rank `94` at score `94.375`. The current post-refresh best `88.245` is `+6.13` below that boundary, roughly equivalent to `68` more successful `EXFILTRATION`-only findings (`~18` raw/candidate). The 2026-08-13 snapshot (`1312` teams, boundary `94.465` at rank `66`) is superseded by this larger, more recent sample.
