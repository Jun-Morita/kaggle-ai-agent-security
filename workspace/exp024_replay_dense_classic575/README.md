# exp024 Replay Dense classic575

Goal: small boundary probe above successful v019 `classic570` after v020-v023 no-scored.
...
```text
submit/v024_replay_dense_classic575/
```

Expected public score if it completes: `51.750`.
