...
- Notes: py_compile, ruff, SDK validate, deterministic smoke, kernel push, and competition submit passed. Hash `e9a7a52d939d`. Runtime-aware sizing did not transfer safely in this wrapper.
