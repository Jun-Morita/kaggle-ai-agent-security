# =====================================================================================
# R1-008
# RELAY V4.1 (direct function-call syntax probe) — adapted from the studied reference "jed-fill-v26-replaysafe" (scored 67; its v24
...
REPLAY_SAFE = 0.94  # ~900s margin (20x the old 45s); lower = safer, higher = more candidates
...
TEMPLATES: tuple[tuple[str, str], ...] = (
    ...
    # Compact Python-style call syntax.  It is deterministic and is selected
    # only after live 2/3-or-better validation, so a model that treats it as
    # plain text automatically falls back to the proven templates.
