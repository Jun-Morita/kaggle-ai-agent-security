...
- Notes: py_compile, ruff, SDK validate, deterministic smoke, kernel push, and competition submit passed. Hash `12e57e861a19`. Direct latency sizing did not transfer safely in this wrapper.
