# v099: R1-009 plus v097 single-post challengers
# =====================================================================================
# Base: yusuketogashi version 52, public 85.635.
# Hybrid change: add only v097's single-post challenger arms to the v098 selector.
# Dual-post arms are intentionally excluded because multi-post replay cost has
# repeatedly underperformed single-post throughput.
# Active settings:
